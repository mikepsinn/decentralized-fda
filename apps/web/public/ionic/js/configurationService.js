angular.module('starter').factory('configurationService', function($http, $q, $rootScope, $state, qmService, $timeout){
    ...
    var onboardingPages = {
        ...
        locationTracking: {
            ...
            "color": qmService.colors.green,
            "image": {"url": "https://static.quantimo.do/img/variable_categories/location.svg"},
        ...
        weatherTracking: {
            ...
            "color": qmService.colors.green,
            "image": {"url": "https://static.quantimo.do/img/variable_categories/environment.png"},
    ...
    configurationService.createApp = function(newApp){
        function sanitizeClientId(clientId){
            ...
            clientId = clientId.toLowerCase().replace(/[\s.'!"?/\\()]/g, '-');
            return clientId;
        }
