...
export class FormatUtils {
   ...
   */
  public static formatCurrency(value: number, options: { abbreviate?: boolean } = {}): string {
   ...
   */
  public static formatConfidenceInterval(value: number, lower: number, upper: number, unit?: string): string {
   ...
   */
  public static formatChange(value: number, options: { showSign?: boolean; asPercentage?: boolean } = {}): string {
